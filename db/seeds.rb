...
def seed_compounds
    Compound.create(units: "g", name: "protein", nutrient_id:1003, description: "Protein is necessary to build, maintain, and repair muscle.
        ...
        so a meal or snack with 25 g total protein provides about 10 g EAAs.", rdv: 200.0 )
    Compound.create(units: "g", name: "fiber, total dietary", nutrient_id:1079 , description:"for digestive", rdv: 30.0)
    Compound.create(units: "mg", name: "calcium, ca", nutrient_id:1087, description:"The body needs calcium to maintain strong bones 
        ...
        that affect almost every function in the human body.", rdv: 1000.0)
    Compound.create(units: "mg", name: "iron, fe", nutrient_id:1089, description:"Iron is a mineral that the body needs for growth and development. 
        ...
        Your body also needs iron to make some hormones and connective tissue.", rdv: 15.0)
    Compound.create(units: "mg", name: "magnesium, mg", nutrient_id:1090, description: "Magnesium is a nutrient that the body needs to stay healthy.
         Magnesium is important for many processes in the body, including regulating muscle and nerve function, blood sugar levels, 
         and blood pressure and making protein, bone, and DNA.", rdv: 400.0)
    Compound.create(units: "mg", name: "manganese, mn", nutrient_id:1101, description: "Manganese is a cofactor for many enzymes, 
        ...
        Manganese also plays a role in blood clotting and hemostasis in conjunction with vitamin K [5].", rdv: 2.0)
    Compound.create(units: "mg", name: "phosphorus, p", nutrient_id:1091, description:"The main function of phosphorus is in the formation 
        ...
        Nerve signaling", rdv: 1000.0)
    Compound.create(units: "mg", name: "potassium, k", nutrient_id:1092, description:"Your body needs potassium for almost everything it does, 
        including proper kidney and heart function, muscle contraction, and nerve transmission.", rdv: 4700.0)
    Compound.create(units: "mg", name: "sodium, na", nutrient_id:1093, description:"Balances fluids in the body.Helps send nerve impulses.
        Needed for muscle contractions. Influences blood pressure; even modest reductions in sodium consumption 
        can lower blood pressure.", rdv: 2300.0)
    Compound.create(units: "mg", name: "zinc, zn", nutrient_id:1095, description: "Zinc is a nutrient that people need to stay healthy. 
        ...
        Zinc also helps wounds heal and is important for proper senses of taste and smell.", rdv: 10.0)
    Compound.create(units: "mg", name: "copper, cu", nutrient_id:1098, description:"Copper works with iron to help the body form red blood cells.
         It also helps keep the blood vessels, nerves, immune system, and bones healthy. Copper also aids in iron absorption.", rdv: 0.9)
    Compound.create(units: "ug", name: "selenium, se", nutrient_id:1103, description:"Selenium is important for reproduction, thyroid gland function, 
        DNA production, and protecting the body from damage caused by free radicals and from infection.", rdv: 55.0)
    Compound.create(units: "iu", name: "vitamin a, iu", nutrient_id:1106, description:"Vitamin A is a fat-soluble vitamin that is naturally present in many foods. 
        ...
        and other plant-based products. The most common type of provitamin A in foods and dietary supplements is beta-carotene.", rdv: 900.0)
    Compound.create(units: "ug", name: "vitamin a, rae", nutrient_id:1106, description:"Vitamin A is a fat-soluble vitamin that is naturally present 
        ...
        The most common type of provitamin A in foods and dietary supplements is beta-carotene.", rdv: 900.0)
    Compound.create(units: "mg", name: "vitamin e (alpha-tocopherol)", nutrient_id:1109, description:"Vitamin E is a fat-soluble nutrient 
    ...
    In addition, cells use vitamin E to interact with each other and to carry out many important functions.", rdv: 15.0)
    Compound.create(units: "mg", name: "vitamin d (d2 + d3)", nutrient_id:1114, description:"Vitamin D is a nutrient found in some foods 
    ...
    Vitamin D is found in cells throughout the body.", rdv: 600.0)
    Compound.create(units: "mg", name: "vitamin c, ascorbic acid", nutrient_id:1162, description:"Vitamin C, also known as ascorbic acid, 
        ...
        absorption of iron from plant-based foods and helps the immune system work properly to protect the body from disease.", rdv: 90.0)
    Compound.create(units: "mg", name: "thiamin", nutrient_id:1165, description:"Thiamin (also called vitamin B1) helps turn the food you eat 
    into the energy you need. Thiamin is important for the growth, development, and function of the cells in your body.", rdv: 1.2 )
    Compound.create(units: "mg", name: "riboflavin", nutrient_id:1166, description:"Riboflavin (also known as vitamin B2) is one of the B vitamins, 
    ...
    flavin adenine dinucleotide (FAD). These coenzymes play major roles in energy production; cellular function, growth, and development;
     ...
     riboflavin helps maintain normal levels of homocysteine, an amino acid in the blood [1].", rdv: 1.3 )
    Compound.create(units: "mg", name: "niacin", nutrient_id:1167, description:"Niacin (also known as vitamin B3) is one of the water-soluble B vitamins. 
    ...
    and related derivatives, such as nicotinamide riboside [1-3]. Niacin is naturally present in many foods, added to some food products,
     ...
     the coenzyme nicotinamide adenine dinucleotide (NAD). More than 400 enzymes require NAD to catalyze reactions in the body,
      ...
      the coenzyme nicotinamide adenine dinucleotide phosphate (NADP), in all tissues except skeletal muscle [4].", rdv: 16.0 )
    Compound.create(units: "mg", name: "pantothenic acid", nutrient_id:1170, description:"The main function of this water-soluble B vitamin is in the synthesis of 
        coenzyme A (CoA) and acyl carrier protein. CoA is essential for fatty acid synthesis and degradation, 
        transfer of acetyl and acyl groups, and a multitude of other anabolic and catabolic processes", rdv: 5.0)
    Compound.create(units: "mg", name: "vitamin b-6", nutrient_id:1175, description:"Vitamin B6 is a vitamin that is naturally present in many foods. 
        The body needs vitamin B6 for more than 100 enzyme reactions involved in metabolism. 
        Vitamin B6 is also involved in brain development during pregnancy and infancy as well as immune function.", rdv: 1.3)
    Compound.create(units: "ug", name: "vitamin b12", nutrient_id:1178, description:"Vitamin B12 is a nutrient that helps 
        keep the body’s nerve and blood cells healthy and helps make DNA, the genetic material in all cells. 
        Vitamin B12 also helps prevent a type of anemia called megaloblastic anemia that makes people tired and weak.", rdv: 2.4)
    Compound.create(units: "mg", name: "choline, total", nutrient_id:1180, description:"Choline is a nutrient that is found in many foods. 
        ...
        amount of choline in your liver, but most of the choline in your body comes from the food you eat.", rdv: 550)
    Compound.create(units: "ug", name: "vitamin k (phylloquinone)", nutrient_id:1185, description:"Vitamin K is a nutrient that the body 
    ...
    same amount of vitamin K each day.", rdv: 120 )
    Compound.create(units: "ug", name: "folate, total", nutrient_id:1177, description:"Folate is a B-vitamin that
         ...
         is used in fortified foods and most dietary supplements.", rdv: 400.0)
end
